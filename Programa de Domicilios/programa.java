...
class program {
  ...
  public static void main(String[] args) {
    ...
    int DocumentoID, Decision_Tienda, Eleccion_Helado, Metodo_Pago, Codigo_tarjeta, Codigo_Seguridad, repetir =
      1, seguir = 1;
    ...
    while (repetir == 1) {
      ...
      switch (Decision_Tienda) {
        ...
        case 2 -> {
          int repetireleccionDP = 1, totalTODO =
            0, productosPizza, cantidad, cantidadFinal = 0, valor;
        ...
        // TIENDA 3, OXXO
        case 3 -> {
          int repetirOXXO = 1, totalTODO = 0, cantidad, cantidadFinal =
            0, valor, categoriaSeleccion;
          JOptionPane.showMessageDialog(
            null,
                ...
                switch (categoriaPaqueteria) {
                  case 1:
                    ...
                    switch (categoriapapas) {
                      case 1:
                        ...
                        switch (categoriamargarita) {
                          ...
                          case 1:
                            JOptionPane.showMessageDialog(
                              null,
                              "has selecionado la papas margarita de pollo con valor de $2500",
                              "papas de pollo",
                              JOptionPane.INFORMATION_MESSAGE
                            );
                            cantidad =
                            ...
                            JOptionPane.showMessageDialog(
                              null,
                              "Ha seleccionado las papas margarita que valen $2500"
                            );
                          ...
                          case 2:
                            JOptionPane.showMessageDialog(
                              null,
                              "has selecionado la papas margarita de limon con valor de $2500",
                              "papas de limon",
                              JOptionPane.INFORMATION_MESSAGE
                            );
                            cantidad =
                          ...
                          case 3:
                            JOptionPane.showMessageDialog(
                              null,
                              "has selecionado la papas margarita bbq con valor de $2500",
                              "papas bbq",
                              JOptionPane.INFORMATION_MESSAGE
                            );
                            cantidad =
                          ...
                          case 4:
                            JOptionPane.showMessageDialog(
                              null,
                              "has selecionado la papas margarita naturales con valor de $2500",
                              "papas naturales",
                              JOptionPane.INFORMATION_MESSAGE
                            );
                            cantidad =
                      ...
                      //papas super ricas
                      case 2:
                        int categorisuperricas = Integer.parseInt(
                          JOptionPane.showInputDialog(
                            null,
                            "Selecccione su producto de papas: \n 1: Papas super ricas de pollo  \n 2: papas super ricas de limon \n 3: papas super ricas bbq \n 4: papas super ricas natural",
                            JOptionPane.INFORMATION_MESSAGE
                          )
                        );
                        switch (categorisuperricas) {
                          //papas super ricas de pollo
                          case 1:
                            JOptionPane.showMessageDialog(
                              null,
                              "has selecionado la papas super ricas de pollo con valor de $2900",
                              "papas de pollo",
                              JOptionPane.INFORMATION_MESSAGE
                            );
                            cantidad =
                              Integer.parseInt(
                                JOptionPane.showInputDialog(
                                  null,
                                  "Cuantas Papas super ricas van a ser?"
                                )
                              );
                            valor = 2900;
                            totalTODO += valor * cantidad;
                            ...
                            JOptionPane.showMessageDialog(
                              null,
                              "Ha seleccionado las papas super ricas que valen $2900"
                            );
                            ...
                            break;
                          //papas super ricas de limon
                          case 2:
                            JOptionPane.showMessageDialog(
                              null,
                              "has selecionado la papas super ricas de limon con valor de $2900",
                              "papas de limon",
                              JOptionPane.INFORMATION_MESSAGE
                            );
                            cantidad =
                            ...
                            break;
                          //papas super ricas bbq
                          case 3:
                            JOptionPane.showMessageDialog(
                              null,
                              "has selecionado la papas super ricas bbq con valor de $2900",
                              "papas bbq",
                              JOptionPane.INFORMATION_MESSAGE
                            );
                            cantidad =
                            ...
                            JOptionPane.showMessageDialog(
                              null,
                              "Ha seleccionado las papas margarita que valen $2900"
                            );
                            ...
                            break;
                          //papas super ricas naturales
                          case 4:
                            JOptionPane.showMessageDialog(
                              null,
                              "has selecionado la papas super ricas naturales con valor de $2900",
                              "papas naturales",
                              JOptionPane.INFORMATION_MESSAGE
                            );
                            cantidad =
