                        ...
                        switch (Decision_Tienda) {
                                ...
                                case 1 -> {
                                        JOptionPane.showMessageDialog(null,
                                                        ...
                                                        "Creppes And Waffles", JOptionPane.INFORMATION_MESSAGE,
                                                        Creppes_And_Waffles);
                                ...
                                case 2 -> {
                                        int repetireleccionDP = 1, totalTODO = 0, productosPizza, cantidad,
                                                        cantidadFinal = 0, valor;

                                        JOptionPane.showMessageDialog(null, "Ha Seleccionado Domino's Pizza",
                                                        "Domino's Pizza",
                                                        JOptionPane.INFORMATION_MESSAGE);
                                        while (repetireleccionDP == 1) {
                                                ...
                                                switch (Metodo_Pago) {
                                                        case 1:
                                                                ...
                                                                Nombre_Titular = JOptionPane.showInputDialog(null,
                                ...
                                case 3 -> {
                                        ...
                                        JOptionPane.showMessageDialog(null, "Ha seleccionado el OXXO", "OXXO",
                                                        JOptionPane.INFORMATION_MESSAGE);
                                        while (repetirOXXO == 1) {
                                                categoriaSeleccion = Integer.parseInt(JOptionPane.showInputDialog(null,
                                                                "Categoria: \n 1: Paqueteria \n 2: Lacteos \n 3: Aseo"));
                                                ...
                                                repetirOXXO = Integer.parseInt(JOptionPane.showInputDialog(null,
                                ...
                                case 4 -> {
                                        ...
                                        JOptionPane.showMessageDialog(null, "Has seleccionado KFC", "KFC",
                                                        JOptionPane.INFORMATION_MESSAGE);
                                        while (repetirKFC == 1) {
